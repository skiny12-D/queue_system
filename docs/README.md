...
```bash
# iOS (com app de terminal como iSH ou Blink Shell)
export SMTP_HOST=smtp.exemplo.com
export SMTP_PORT=587
export SMTP_USER=utilizador@exemplo.com
export SMTP_PASS=senha
...
> Nota: no iOS, pode ser necessário usar `python3` em vez de `python`, dependendo da instalação. Se estiver a usar um ambiente como Pythonista, instale pacotes com as ferramentas disponíveis nesse app.
